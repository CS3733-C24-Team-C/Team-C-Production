                ...
                <div className="flex justify-between items-center pt-5">
                    ...
                    <div id="empTypeDropdown"
                        ...
                        <ul className="py-2 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                                <a href="#"
                                   className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Admin</a>
                            </li>
                            <li>
                                <a href="#"
                                   className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Employee</a>
                            </li>
                        </ul>
                    </div>
                </div>
